...
struct syscall_entry SYSCALL_TABLE[MAX_SYSCALL_NB] = {
    ...
    [43]
    = { "accept", 3, NUM, { NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, 0, 0, 0 } },
    [44] = { "sendto", 6, NUM,
    ...
    [49]
    = { "bind", 3, NUM, { NUM, CONST_STRUCT_SOCKADDR_P, SOCKLEN_T, 0, 0, 0 } },
    ...
    [54]
    = { "setsockopt", 5, NUM, { NUM, NUM, NUM, CONST_VOID_P, SOCKLEN_T, 0 } },
    ...
    [101]
    = { "ptrace", 4, NUM, { ENUM_____REQUEST, NUM, VOID_P, VOID_P, 0, 0 } },
    ...
    [125]
    = { "capget", 2, NUM, { CAP_USER_HEADER_T, CAP_USER_DATA_T, 0, 0, 0, 0 } },
    [126] = { "capset", 2, NUM,
    ...
    [131]
    = { "sigaltstack", 2, NUM, { CONST_STACK_T_P, STACK_T_P, 0, 0, 0, 0 } },
    ...
    [143]
    = { "sched_getparam", 2, NUM, { NUM, STRUCT_SCHED_PARAM_P, 0, 0, 0, 0 } },
    ...
    [157]
    = { "prctl", 5, NUM, { NUM, UNSIGNED, UNSIGNED, UNSIGNED, UNSIGNED, 0 } },
    ...
    [177]
    = { "get_kernel_syms", 1, NUM, { STRUCT_KERNEL_SYM_P, 0, 0, 0, 0, 0 } },
    ...
    [188]
    = { "setxattr", 5, NUM, { STRING, STRING, CONST_VOID_P, NUM, NUM, 0 } },
    [189]
    = { "lsetxattr", 5, NUM, { STRING, STRING, CONST_VOID_P, NUM, NUM, 0 } },
    ...
    [203]
    = { "sched_setaffinity", 3, NUM, { NUM, NUM, CONST_CPU_SET_T_P, 0, 0, 0 } },
    [204] = { "sched_getaffinity", 3, NUM, { NUM, NUM, CPU_SET_T_P, 0, 0, 0 } },
    [205]
    = { "set_thread_area", 1, NUM, { STRUCT_USER_DESC_P, 0, 0, 0, 0, 0 } },
    ...
    [209]
    = { "io_submit", 3, NUM, { AIO_CONTEXT_T, NUM, STRUCT_IOCB_P, 0, 0, 0 } },
    [210] = { "io_cancel", 3, NUM,
        { AIO_CONTEXT_T, STRUCT_IOCB_P, STRUCT_IO_EVENT_P, 0, 0, 0 } },
    [211]
    = { "get_thread_area", 1, NUM, { STRUCT_USER_DESC_P, 0, 0, 0, 0, 0 } },
    ...
    [223] = { "timer_settime", 4, NUM,
        { TIMER_T, NUM, CONST_STRUCT_ITIMERSPEC_P, STRUCT_ITIMERSPEC_P, 0,
            0 } },
    [224]
    = { "timer_gettime", 2, NUM, { TIMER_T, STRUCT_ITIMERSPEC_P, 0, 0, 0, 0 } },
    ...
    [228]
    = { "clock_gettime", 2, NUM, { CLOCKID_T, STRUCT_TIMESPEC_P, 0, 0, 0, 0 } },
    [229]
    = { "clock_getres", 2, NUM, { CLOCKID_T, STRUCT_TIMESPEC_P, 0, 0, 0, 0 } },
    [230] = { "clock_nanosleep", 4, NUM,
        { CLOCKID_T, NUM, CONST_STRUCT_TIMESPEC_P, STRUCT_TIMESPEC_P, 0, 0 } },
    [231] = { "exit_group", 1, VOID, { NUM, 0, 0, 0, 0, 0 } },
    [232]
    = { "epoll_wait", 4, NUM, { NUM, STRUCT_EPOLL_EVENT_P, NUM, NUM, 0, 0 } },
    [233]
    = { "epoll_ctl", 4, NUM, { NUM, NUM, NUM, STRUCT_EPOLL_EVENT_P, 0, 0 } },
    ...
    [238]
    = { "set_mempolicy", 3, NUM, { NUM, CONST_UNSIGNED_P, UNSIGNED, 0, 0, 0 } },
    ...
    [244]
    = { "mq_notify", 2, NUM, { MQD_T, CONST_STRUCT_SIGEVENT_P, 0, 0, 0, 0 } },
    [245] = { "mq_getsetattr", 3, NUM,
        { MQD_T, STRUCT_MQ_ATTR_P, STRUCT_MQ_ATTR_P, 0, 0, 0 } },
    [246] = { "kexec_load", 4, NUM,
    ...
    [261]
    = { "futimesat", 3, NUM, { NUM, STRING, CONST_STRUCT_TIMEVAL, 0, 0, 0 } },
    ...
    [271] = { "ppoll", 4, NUM,
        { STRUCT_POLLFD_P, UNSIGNED, CONST_STRUCT_TIMESPEC_P, CONST_SIGSET_T_P,
            0, 0 } },
    ...
    [277]
    = { "sync_file_range", 4, NUM, { NUM, OFF64_T, OFF64_T, UNSIGNED, 0, 0 } },
    [278] = { "vmsplice", 4, NUM,
    ...
    [287]
    = { "timerfd_gettime", 2, NUM, { NUM, STRUCT_ITIMERSPEC_P, 0, 0, 0, 0 } },
    [288]
    = { "accept4", 4, NUM, { NUM, STRUCT_SOCKADDR_P, SOCKLEN_T_P, NUM, 0, 0 } },
    ...
    [296]
    = { "pwritev", 4, NUM, { NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, 0, 0 } },
    ...
    [301]
    = { "fanotify_mark", 5, NUM, { NUM, UNSIGNED, UNUM64_T, NUM, STRING, 0 } },
    ...
    [327]
    = { "preadv2", 5, NUM, { NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, NUM, 0 } },
    [328]
    = { "pwritev2", 5, NUM, { NUM, CONST_STRUCT_IOVEC_P, NUM, NUM, NUM, 0 } },
};
